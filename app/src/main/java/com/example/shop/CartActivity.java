            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists())
                {
                    ...
                    if(shippingState.equals("shipped"))
                    {
                        ...
                        txtMsg1.setText("Congratulation, Your final order has been shipped successfully. Soon it will be vertified.");
                        NextProcessBtn.setVisibility(View.GONE);

                        Toast.makeText(CartActivity.this, "you can purchase products, one you received your first final order.", Toast.LENGTH_SHORT).show();
                    }
